...
import javax.swing.*;  
import java.sql.*;
class quez extends JFrame 
{
	static TextField  t = new TextField(20);
	static JButton c = new JButton("Proceed");
	static String s;
	static JFrame frame = new JFrame();
	static JPanel panel1 = new JPanel();
	static JPanel panel2 = new JPanel();
	static JLabel l1= new JLabel("Enter Your Name:");
	...
	c.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
        	try {
        		...
        		Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/quiz", "root", "harsha");
        		PreparedStatement p= con.prepareStatement("insert into userame(Useramecol)values(?)");
...
class Quiz extends quez  implements ActionListener
{  
    JLabel l;  
    JRadioButton jb[]=new JRadioButton[5];  
    JButton b1,b2;  
    ButtonGroup bg;  
    int count=0,current=0,x=1,y1=1,now=0;  
    int m[]=new int[10];      
    ...
    public void actionPerformed(ActionEvent e)  
    {
        ...
        {  
            ...
            bk.setBounds(450,20+30*x,111,30);  
            add(bk);  
        ...
        {  
        if(e.getActionCommand().equals("Bookmark "+y1))  
        {  
            if(check())  
                count=count+1;  
            now=current;  
